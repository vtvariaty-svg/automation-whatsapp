...
const PLAN_STEPS: Record<string, StepDef[]> = {
  free: [
    ...
    { id: 'automation',         title: 'Criar automação',           description: 'Adicione pelo menos 1 resposta automática por palavra-chave.',  href: '/dashboard/automations',    cta: 'Criar automação',     priority: 3 },
  ...
  standard: [
    ...
    { id: 'automation',         title: 'Criar automação',                 description: 'Adicione pelo menos 1 resposta automática por palavra-chave.',  href: '/dashboard/automations',    cta: 'Criar automação',       priority: 5 },
  ...
  business: [
    ...
    { id: 'automation',         title: 'Criar automação principal',   description: 'Publique pelo menos 1 resposta automática ativa.',              href: '/dashboard/automations',    cta: 'Criar automação',       priority: 5 },
