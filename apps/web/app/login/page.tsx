    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex flex-1 flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 bg-white">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="mb-8">
            <img src="/logo.png" alt="Variaty Secretary" className="h-28 w-auto" style={{mixBlendMode:"multiply"}} />
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm font-medium text-[#4f46e5] hover:text-[#4338ca]">
                  Esqueceu a senha?
                </Link>
              </div>
              <Input
