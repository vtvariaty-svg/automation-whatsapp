    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        <Link href="/" className="flex items-center">
          <Image src="/logo.png" alt="Variaty Secretary" unoptimized width={200} height={90} className="h-16 w-auto object-contain" priority />
        </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <div className="mb-4">
              <Image src="/logo.png" alt="Variaty Secretary" unoptimized width={220} height={100} className="h-20 w-auto object-contain" />
            </div>
