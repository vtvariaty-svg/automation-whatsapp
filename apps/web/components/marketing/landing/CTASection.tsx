    ...
    <section className="relative bg-[#080d19] overflow-hidden pt-28 pb-40">
      ...
      <div className="relative max-w-2xl mx-auto px-4 text-center z-10 pt-14">
        ...
        <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 mb-8">
          ...
          <span className="text-xs font-bold text-slate-300 uppercase tracking-widest">Pronto para começar</span>
        </div>

        {/* Headline — curta e direta */}
        <h2 className="text-4xl md:text-5xl lg:text-[3.25rem] font-extrabold text-white mb-5 leading-[1.06] tracking-tight">
        ...
        {/* Subheadline */}
        <p className="text-lg md:text-xl text-slate-400 mb-4 font-medium leading-relaxed">
          Configure sua IA, conecte seu WhatsApp e veja a operação rodar — em minutos.
        </p>

        {/* Zero-risk anchors */}
        <p className="text-sm text-slate-500 font-semibold mb-10 tracking-wide">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2.5 bg-white/5 hover:bg-white/10 border border-white/10 px-8 py-5 rounded-2xl text-slate-300 font-semibold transition-all backdrop-blur-sm group hover:-translate-y-1 text-sm"
          >
