...
export function CTASection() {
  return (
    <section className="relative bg-[#080d19] overflow-hidden pt-32 pb-44">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-indigo-600/10 rounded-full blur-[120px] pointer-events-none mix-blend-screen" />

      <div className="relative max-w-3xl mx-auto px-4 text-center z-10 pt-16">
        <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 mb-10">
          ...
          <span className="text-xs font-bold text-slate-300 uppercase tracking-widest">Comece em minutos</span>
        </div>

        <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-7 leading-[1.06] tracking-tight">
          Experimente a Variaty e transforme seu WhatsApp em uma operação{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400">
            mais rápida e comercial
          </span>
        </h2>
        <p className="text-lg md:text-xl text-slate-400 mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
          Sem contrato. Sem cartão de crédito. Sua operação no ar em minutos.
        </p>
