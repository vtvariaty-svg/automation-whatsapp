  ...
  return (
    <section className="relative pt-32 pb-24 lg:pt-40 lg:pb-32 overflow-hidden bg-[#080d19]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left pt-8 md:pt-0">
            ...
            <div className="inline-flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full px-4 py-1.5 mb-8">
              ...
              <span className="text-xs sm:text-sm font-bold text-indigo-300 uppercase tracking-widest">
                WhatsApp · IA Assistiva · 24/7
              </span>
            </div>

            {/* Headline */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-[4.25rem] font-extrabold text-white tracking-tight leading-[1.05] mb-5">
            ...
            {/* Subheadline */}
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-10 max-w-lg mx-auto lg:mx-0 font-medium">
              O Variaty ajuda clínicas, consultórios, restaurantes e negócios locais a responder mais rápido, organizar conversas e transformar atendimento em operação.
            </p>

            {/* CTAs — segmented */}
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 mb-10 flex-wrap">
              <Link
                href="/clinicas"
                className="w-full sm:w-auto flex items-center justify-center gap-2 text-sm font-extrabold bg-teal-600 text-white px-7 py-4 rounded-xl shadow-[0_0_30px_rgba(20,184,166,0.35)] hover:bg-teal-500 transition-all hover:-translate-y-1 ring-2 ring-teal-500/30 focus-visible:outline-none focus-visible:ring-teal-400"
              >
                Sou clínica ou consultório
              ...
              <Link
                href="/restaurantes"
                className="w-full sm:w-auto flex items-center justify-center gap-2 text-sm font-extrabold bg-orange-500 text-white px-7 py-4 rounded-xl shadow-[0_0_30px_rgba(249,115,22,0.35)] hover:bg-orange-400 transition-all hover:-translate-y-1 ring-2 ring-orange-500/30 focus-visible:outline-none focus-visible:ring-orange-400"
              >
                Sou restaurante ou delivery
                <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
              </Link>
              <a
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2.5 bg-white/5 hover:bg-white/10 border border-white/10 px-7 py-4 rounded-xl text-slate-200 font-semibold transition-all backdrop-blur-sm hover:-translate-y-0.5 text-sm"
              >
            ...
            {/* Micro Trust */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-x-5 gap-y-2 text-sm text-slate-500 font-medium">
              <span className="flex items-center gap-1.5">
                <svg className="w-3.5 h-3.5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
          ...
          <div className="relative w-full aspect-square md:aspect-[4/3] lg:aspect-square flex items-center justify-center -mt-4 lg:mt-0 lg:scale-[1.03]">
            ...
            <div className="hidden sm:block absolute -bottom-4 right-8 lg:right-4 w-[28%] lg:w-[26%] rounded-[1.8rem] shadow-[0_40px_70px_rgba(0,0,0,0.5)] border-4 border-slate-800 bg-white z-30 overflow-hidden transform hover:-translate-y-3 transition-transform duration-500">
              <div className="relative w-full aspect-[9/19] bg-white">
                <img src="/landing-v4/hero/hero-phone-right.webp" alt="Conversa de atendimento" className="absolute inset-0 w-full h-full object-cover" />
              </div>
            </div>

            {/* Floating Card 1 */}
            <div className="absolute top-16 -left-4 lg:-left-12 bg-white/95 backdrop-blur-xl shadow-2xl shadow-indigo-500/10 border border-white/20 p-3.5 rounded-2xl flex items-center gap-3.5 z-40 animate-[bounce_4s_infinite]">
              ...
              <div>
                <p className="font-extrabold text-sm text-gray-900 tracking-tight leading-none">Consulta Agendada</p>
                <p className="text-[10px] text-emerald-600 font-bold uppercase tracking-widest mt-1">IA · Automático</p>
              </div>
            </div>
            ...
            <div className="hidden lg:block absolute bottom-1/4 -right-10 z-40 animate-[bounce_6s_infinite_2s]">
              <img src="/landing-v4/hero/hero-floating-card-2.webp" alt="Pedido organizado" className="h-16 w-auto drop-shadow-2xl opacity-90" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 w-full z-0 overflow-hidden pointer-events-none">
        <img src="/landing-v4/backgrounds/wave-top.svg" alt="" className="w-full min-w-[1440px] h-[60px] md:h-[120px] object-cover object-bottom" />
      </div>
    </section>
  );
}
