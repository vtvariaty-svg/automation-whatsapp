        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left pt-8 md:pt-0">
            ...
            <div className="inline-flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full px-4 py-1.5 mb-8">
              ...
              <span className="text-xs sm:text-sm font-bold text-indigo-300 uppercase tracking-widest">
                API Oficial Meta · Operação 24/7
              </span>
            </div>

            {/* Headline — curta, direta, poderosa */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-[4.25rem] font-extrabold text-white tracking-tight leading-[1.05] mb-5">
              ...
              agendando e vendendo{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400">
                enquanto você dorme.
              </span>
            </h1>

            {/* Subheadline — objetiva, orientada a resultado */}
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-10 max-w-lg mx-auto lg:mx-0 font-medium">
              IA + automação + controle humano integrados. Responda mais rápido, qualifique seus leads e feche mais — sem precisar aumentar o time.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-10">
              <Link
                href="/register"
                className="w-full sm:w-auto flex items-center justify-center gap-2 text-base font-extrabold bg-blue-600 text-white px-8 py-4 rounded-xl shadow-[0_0_35px_rgba(37,99,235,0.45)] hover:bg-blue-500 transition-all hover:-translate-y-1 ring-2 ring-blue-500/30"
              >
              ...
              <a
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2.5 bg-white/5 hover:bg-white/10 border border-white/10 px-8 py-4 rounded-xl text-slate-200 font-semibold transition-all backdrop-blur-sm group hover:-translate-y-0.5 text-sm"
              >
                <svg className="w-4 h-4 fill-[#25D366] opacity-90 group-hover:opacity-100" viewBox="0 0 24 24">
            ...
            {/* Micro Trust — ancoragem de baixo custo */}
          ...
          <div className="relative w-full aspect-square md:aspect-[4/3] lg:aspect-square flex items-center justify-center -mt-4 lg:mt-0 lg:scale-[1.03]">
            ...
            <div className="absolute top-16 -left-4 lg:-left-12 bg-white/95 backdrop-blur-xl shadow-2xl shadow-indigo-500/10 border border-white/20 p-3.5 rounded-2xl flex items-center gap-3.5 z-40 animate-[bounce_4s_infinite]">
              ...
              <div>
                <p className="font-extrabold text-sm text-gray-900 tracking-tight leading-none">Reunião Agendada</p>
